...
DGL_REGISTER_GLOBAL("sparse._CAPI_DGLlibra2dgl_build_adj_v2")
.set_body([] (DGLArgs args, DGLRetValue* rv) {
    ...
    libra2dgl_build_adj_v2(feat_, gfeat_, adj_, inner_node_,
...
DGL_REGISTER_GLOBAL("sparse._CAPI_DGLlibra2dgl_build_adj")
.set_body([] (DGLArgs args, DGLRetValue* rv) {
    NDArray feat_       = args[0];
    NDArray gfeat_      = args[1];
    NDArray adj_        = args[2];
    ...
    libra2dgl_build_adj(feat_, gfeat_, adj_, inner_node_, 
                        ldt_key_, gdt_key_, gdt_value_,
